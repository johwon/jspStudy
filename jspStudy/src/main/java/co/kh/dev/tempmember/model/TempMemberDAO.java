...
public class TempMemberDAO {
	...
	private final String UPDATE_SQL = "UPDATE TEMPMEMBER SET PWD = ?,NAME= ? ,EMAIL= ? ,BIRTH= ? WHERE ID = ?";
...
//        }
		...
		try {
			...
			while (rs.next()) {
				...
				TempMemberVO tmvo = new TempMemberVO(id, passwd, name, memNum1, memNum2, e_mail, phone, zipcode, address, job);
				tmList.add(tmvo);
			}
