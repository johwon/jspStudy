package co.kh.dev.login2.model;
...
public class LoginDAO {
	private final String LOGIN_SELECT = "SELECT * FROM Login2";
	private final String LOGIN_UPDATE = "update login2 set pass = ? where id = ?";
	private final String LOGIN_INSERT = "insert into login2 values(?,?,?)";
	private final String LOGIN_DELETE = "delete from login2 where id = ?";
